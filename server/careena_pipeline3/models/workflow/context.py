...
from careena_pipeline3.models.common import DialogueTopicStatus, PipelineModel, PlannerModule
...
class IntentGatewayContext(PipelineModel):
    ...
    active_choice_prompt_kind: str | None = None
    active_choice_prompt_code: str | None = None
