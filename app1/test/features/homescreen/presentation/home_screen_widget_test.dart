...
void main() {
  group('HomeScreen - UI & Widget-Rendering Tests', () {
    testWidgets(
      'Sollte den Willkommenstext und die Careena-Aufforderungskarte korrekt auf dem Screen rendern',
          (WidgetTester tester) async {
        // Setup: Abhängigkeiten aufbauen, um das HomeScreen-Widget in der Testumgebung zu laden
        ...
        expect(
          find.text('Willkommen!'),
          findsOneWidget,
          reason:
          'Der Willkommensgruß muss auf der Startseite gut sichtbar gerendert werden.',
        );

        // Verification 2: Prüfen, ob der Text auf der Hero-Card vorhanden ist
        expect(
          find.textContaining('Ich bin Careena!'),
          findsOneWidget,
          reason:
          'Die Einstiegskarte für den Chatbot muss für den Nutzer sofort ins Auge springen.',
        );
      },
    );
  });
