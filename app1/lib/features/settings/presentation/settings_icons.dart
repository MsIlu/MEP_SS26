...
/// Shared icons for settings entries and their matching detail pages.
abstract final class SettingsIcons {
  ...
  static const userManual = Icons.picture_as_pdf_outlined;
  ...
  static const healthData = Icons.health_and_safety_outlined;
}
