...
Short description:
Represents the canonical medical case state for one dialogue.
It keeps subject data, observations, visible case issues, and the current primary focus together.
"""
